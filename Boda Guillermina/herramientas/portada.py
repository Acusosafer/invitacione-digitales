...
.colgante.sube{animation:none;transform:translateY(-130%) rotate(-2deg);
  opacity:0;transition:transform 1000ms var(--ease),opacity 800ms 200ms linear}
    ...
    <div class="etiqueta" id="eti">
      <div class="cara">
        ...
        <div class="escrito dorso">
          <div class="dat">S&aacute;bado<span class="g">3 &middot; IV &middot; 2027</span>
